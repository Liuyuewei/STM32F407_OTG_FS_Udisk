...
*/
  ...
  #define MESSAGEBOX_BORDER 60      //40
#endif

#ifndef MESSAGEBOX_XSIZEOK
  #define MESSAGEBOX_XSIZEOK 80    //50
#endif     

#ifndef MESSAGEBOX_YSIZEOK
  #define MESSAGEBOX_YSIZEOK 40   // 20
#endif
...
WM_HWIN MESSAGEBOX_Create(const char * sMessage, const char * sCaption, int Flags) {
  ...
  int xSizeFrame = MESSAGEBOX_XSIZEOK + 50 + 2 * BorderSize + MESSAGEBOX_BORDER * 2; /* XSize of frame window */
  ...
  _aDialogCreate[0].xSize            = xSizeFrame + 60;	 //add by zl 原来为ySizeFrame
  _aDialogCreate[0].ySize            = ySizeFrame - 50;	 //add by zl 原来为ySizeFrame
  ...
  _aDialogCreate[1].x0               = (xSizeFrame - xSizeMessage - BorderSize * 2) / 2 - 50; //add by zl 原来不减20
  _aDialogCreate[1].y0               = MESSAGEBOX_BORDER -40;
  _aDialogCreate[1].xSize            = xSizeMessage + 140;		  //modify by zl 原来不加20
  _aDialogCreate[1].ySize            = ySizeMessage + 20;		  //modify by zl 原来不-20
  ...
  _aDialogCreate[2].x0               = (xSizeFrame - MESSAGEBOX_XSIZEOK - BorderSize * 2) / 2 + 20;
  _aDialogCreate[2].y0               = MESSAGEBOX_BORDER * 2 + ySizeMessage -20;
